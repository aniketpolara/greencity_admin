...
class BanquetHall extends StatefulWidget {
  const BanquetHall({super.key});

  @override
  State<BanquetHall> createState() => _BanquetHallState();
}
              ...
              CircleAvatar(
                ...
                child: InkWell(
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          fit: BoxFit.cover,
                                          image: AssetImage(imgBanquetHall),
                                        ),
                                      ),
                                    )
                                  ],
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage(imgBanquetHall),
                  ),
                ),
              ),
              SizedBox(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      text(
                                          text: banquetHallData[index]['name'],
                                  ...
                                  Row(
                                    children: [
                                      text(
                                          text: banquetHallData[index]['date']),
                                    ],
                                  ),
                                  SizedBox(
                                  ...
                                  Row(
                                    children: [
                                      text(
                                          text: banquetHallData[index]['time']),
                                    ],
                                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                text(
                                    text: banquetHallData[index]['flatNo'],
