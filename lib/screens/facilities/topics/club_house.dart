...
class ClubHouseScreen extends StatefulWidget {
  const ClubHouseScreen({super.key});

  @override
  State<ClubHouseScreen> createState() => _ClubHouseScreenState();
}
              ...
              CircleAvatar(
                ...
                child: InkWell(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage(imgClubHouse),
                  ),
                ),
              ),
              // CircleAvatar(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      text(text: clubHouseData[index]['date']),
                                    ],
                                  ),
                                  SizedBox(
                                  ...
                                  Row(
                                    children: [
                                      text(text: clubHouseData[index]['time']),
                                    ],
                                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                text(
                                    text: clubHouseData[index]['flatNo'],
